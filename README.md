About coverage-conditional-plugin
=================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/coverage-conditional-plugin-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14096&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/coverage-conditional-plugin-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `coverage-conditional-plugin` can be installed with:

```
conda install coverage-conditional-plugin
```

It is possible to list all of the versions of `coverage-conditional-plugin` available on your platform with:
